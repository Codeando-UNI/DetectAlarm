...
// estacion.waposat.com/Public_html/Template/InsertData3.php?equipo=20&sensor1=2&sensor2=5&sensor3=6&valor1=1&valor2=3&valor3=4
...
$monitoreo->verificarRegistrarValor($id_sensor1, $id_equipo, $valor1);
$monitoreo->verificarRegistrarValor($id_sensor2, $id_equipo, $valor2);
$monitoreo->verificarRegistrarValor($id_sensor3, $id_equipo, $valor3);
